...
internal class Demo_Page_Main : PageUiManagerBase
{
    ...
    protected override void Build(IView v)
    {
        ...
        b.GetRes("game_adventureView", rect_game, (_, view) =>
        {
            game_adventureView = new Page_main_adventureView(view);
        });
        b.GetRes("page_main_diziInfo", rect_top, (_, view) =>
        {
            main_diziInfo = new Page_main_diziInfo(view);
        });
        ...
        {
            main_diziList = new Page_main_diziList(view, dizi =>
            {
