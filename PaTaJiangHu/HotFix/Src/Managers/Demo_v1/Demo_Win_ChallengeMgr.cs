...
internal class Demo_Win_ChallengeMgr : WinUiManagerBase
{
    ...
    public void ChallengingWindow()
    {
        ...
        if (challenge == null)
        {
            ...
            win_challenge.UnChallengeWindow(newChallenge.Name,
                ...
                newChallenge.About, () => UiAgent.ShowChallengeState());
            return;
        }
        win_challenge.ChallengingWindow(challenge.StageName,challenge.StageImage,challenge.Progress,challenge.StageCount,challenge.StageInfo);
    }
    public override void Show() => win_challenge.Display(true);
    ...
    private class Win_challenge : UiBase
    {
        ...
        public Win_challenge(IView v,Action onCloseAction,Action onChallengeRedirection,Action onChallengeGiveup) : base(v, false)
        {
