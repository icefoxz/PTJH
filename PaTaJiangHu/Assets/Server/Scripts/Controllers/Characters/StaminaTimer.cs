...
namespace Server.Controllers.Characters
{
    public interface IStaminaTimer : ISingletonDependency
    {
        ...
        void Init(int baseStamina, long lastTick, StaminaGenerateSo staminaGenerator);
    ...
    public class StaminaTimer : DependencySingleton<IStaminaTimer>, IStaminaTimer
    {
        ...
        public void Init(int baseStamina, long lastTick, StaminaGenerateSo staminaGenerator)
        {
            IsInit = true;
