...
namespace Server.Controllers
{
    ...
    public class TestTestDiziController : ITestDiziController
    {
        ...
        {
            Config = config;
            StaminaTimer = new GameObject(nameof(Configs.Characters.StaminaTimer)).AddComponent<StaminaTimer>();
        }
        ...
        private Dizi GenerateDizi(int grade)
        {
            ...
            var cap = new Capable(grade: grade, combatSlot: 5, forceSlot: 2, dodgeSlot: 3, bag: inv,
