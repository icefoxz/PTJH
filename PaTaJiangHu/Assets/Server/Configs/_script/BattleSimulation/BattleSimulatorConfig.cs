...
namespace Server.Configs.BattleSimulation
{
    ...
    internal class BattleSimulatorConfig : ScriptableObject
    {
        ...
        public ISimulationOutcome CountSimulationOutcome(ISimulation player, ISimulation enemy)
        {
            ...
            while (true)
            {
                ...
                if (enemyHp <= 0)
                {
                    ...
                    return new Outcome(list.ToArray(), (int)playerHp, playerHp / player.Defend, true, player.Offend,
        ...
        public record Outcome : ISimulationOutcome
        {
            ...
            public Outcome(ISimulationRound[] rounds, int remainingHp, float remainingRatio, bool isPlayerWin, float playerOffend, float enemyOffend, float playerDefend, float enemyDefend)
            {
                Rounds = rounds;
