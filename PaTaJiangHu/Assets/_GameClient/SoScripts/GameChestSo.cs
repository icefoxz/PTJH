...
namespace GameClient.SoScripts
{
    ...
    internal class GameChestSo : GameChestSoBase
    {
        ...
        public IItemPackage[] Packages => Reward.Packages;
    ...
    internal abstract class GameChestSoBase : AutoAtNamingObject
    {
        ...
        internal record GameChest(int Id, string Name, IItemPackage[] Packages, IGameItem[] AllItems) : IGameChest
        {
            public int Id { get; } = Id;
            public string Name { get; } = Name;
            public IItemPackage[] Packages { get; } = Packages;
