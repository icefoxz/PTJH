...
{
    unsafe class BattleM_ISkill_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BattleM.ISkill);
            args = new Type[]{};
        ...
        static StackObject* get_Level_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BattleM.ISkill instance_of_this_method = (BattleM.ISkill)typeof(BattleM.ISkill).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
