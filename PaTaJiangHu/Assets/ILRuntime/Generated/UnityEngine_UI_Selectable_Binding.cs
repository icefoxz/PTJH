...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Selectable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_image_0);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_interactable", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_interactable_1);


        }


        static StackObject* get_image_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_interactable_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
