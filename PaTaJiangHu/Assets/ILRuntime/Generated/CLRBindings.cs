...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            Server_Controllers_Adventures_AdventureController_Binding_AdvEvent_Binding.Register(app);
            Systems_Messaging_UnityButtonExtension_Binding.Register(app);
            Server_Controllers_Adventures_AdventureController_Binding_Map_Binding.Register(app);
            Views_IView_Binding.Register(app);
            UnityEngine_UI_ScrollRect_Binding.Register(app);
            UnityEngine_UI_Text_Binding.Register(app);
            Server_ITestCaller_Binding.Register(app);
            System_Threading_Interlocked_Binding.Register(app);
            System_Linq_Enumerable_Binding.Register(app);
            Server_Controllers_Adventures_AdventureController_Binding_StoryEvent_Binding.Register(app);
            Server_Controllers_Adventures_AdventureController_Binding_OptionEvent_Binding.Register(app);
            Server_Controllers_Adventures_AdventureController_Binding_BattleEvent_Binding.Register(app);
            Server_Controllers_Adventures_AdventureController_Binding_RewardEvent_Binding.Register(app);
            ...
            Server_Controllers_Adventures_AdventureController_Binding_DialogEvent_Binding.Register(app);
            ...
            Server_Controllers_Characters_IStaminaTimer_Binding.Register(app);
