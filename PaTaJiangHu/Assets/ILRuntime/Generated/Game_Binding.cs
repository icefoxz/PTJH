...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Game_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("GetColorFromItemGrade", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetColorFromItemGrade_6);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetColorFromGrade", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetColorFromGrade_7);
            args = new Type[]{};
            method = type.GetMethod("get_UiBuilder", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_UiBuilder_8);
            args = new Type[]{};
            method = type.GetMethod("get_CoService", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_CoService_9);
        ...
        static StackObject* GetColorFromItemGrade_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            ...
            System.Int32 @grade = ptr_of_this_method->Value;


            var result_of_this_method = global::Game.GetColorFromItemGrade(@grade);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* GetColorFromGrade_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = global::Game.GetColorFromGrade(@grade);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* get_UiBuilder_8(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* get_CoService_9(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
