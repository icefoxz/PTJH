...
{
    unsafe class System_Collections_Generic_IDictionary_2_String_ILRuntimeAdapters_IListAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.IDictionary<System.String, ILRuntimeAdapters.IListAdapter.Adapter>);
            args = new Type[]{};
            method = type.GetMethod("get_Keys", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Keys_0);
            args = new Type[]{typeof(System.String), typeof(ILRuntimeAdapters.IListAdapter.Adapter)};
            ...
            args = new Type[]{typeof(System.String), typeof(ILRuntimeAdapters.IListAdapter.Adapter).MakeByRefType()};
        ...
        static StackObject* get_Keys_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.IDictionary<System.String, ILRuntimeAdapters.IListAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.IDictionary<System.String, ILRuntimeAdapters.IListAdapter.Adapter>)typeof(System.Collections.Generic.IDictionary<System.String, ILRuntimeAdapters.IListAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_Item_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntimeAdapters.IListAdapter.Adapter @value = (ILRuntimeAdapters.IListAdapter.Adapter)typeof(ILRuntimeAdapters.IListAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntimeAdapters.IListAdapter.Adapter @value = (ILRuntimeAdapters.IListAdapter.Adapter)typeof(ILRuntimeAdapters.IListAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntimeAdapters.IListAdapter.Adapter[];
