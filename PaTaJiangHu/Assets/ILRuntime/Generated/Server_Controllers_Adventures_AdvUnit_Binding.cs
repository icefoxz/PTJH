...
{
    unsafe class Server_Controllers_Adventures_AdvUnit_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Server.Controllers.Adventures.AdvUnit);
            args = new Type[]{};
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Server.Controllers.Adventures.AdvUnit instance_of_this_method = (Server.Controllers.Adventures.AdvUnit)typeof(Server.Controllers.Adventures.AdvUnit).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
