...
{
    unsafe class Server_Controllers_Adventures_AdventureController_Binding_AdvEvent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Server.Controllers.Adventures.AdventureController.AdvEvent);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_MapId", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_MapId_3);
        ...
        static StackObject* get_AdvType_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Server.Controllers.Adventures.AdventureController.AdvEvent instance_of_this_method = (Server.Controllers.Adventures.AdventureController.AdvEvent)typeof(Server.Controllers.Adventures.AdventureController.AdvEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* get_MapId_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.MapId;
