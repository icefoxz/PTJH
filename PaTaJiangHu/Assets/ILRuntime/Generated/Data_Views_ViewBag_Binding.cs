...
{
    unsafe class Data_Views_ViewBag_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Data.Views.ViewBag);
            args = new Type[]{};
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Data.Views.ViewBag instance_of_this_method = (Data.Views.ViewBag)typeof(Data.Views.ViewBag).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
