...
{
    unsafe class Systems_Messaging_UnityEventExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Systems.Messaging.UnityEventExtension);
            ...
            args = new Type[]{typeof(UnityEngine.Events.UnityEvent<System.String>), typeof(System.Action<System.String>), typeof(System.Boolean)};
        ...
        static StackObject* OnClickAdd_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Systems.Messaging.UnityEventExtension.OnClickAdd(@btn, @action, @removeAllListener);

            return __ret;
        }

        static StackObject* AddAction_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            UnityEngine.Events.UnityEvent<System.String> @unityEvent = (UnityEngine.Events.UnityEvent<System.String>)typeof(UnityEngine.Events.UnityEvent<System.String>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);


            Systems.Messaging.UnityEventExtension.AddAction(@unityEvent, @action, @removeAllListener);
