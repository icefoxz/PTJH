...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Color_Binding
    {
        ...
        static StackObject* CopyToStack_r_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_r_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
        ...
        static StackObject* CopyToStack_g_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_g_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_b_2(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_b_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
