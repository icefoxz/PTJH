...
namespace ILRuntime.Runtime.Generated
{
    unsafe class _GameClient_Models_AutoAdventure_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_StoryLog_1);
            args = new Type[]{};
            method = type.GetMethod("get_Rewards", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Rewards_2);
            args = new Type[]{};
        ...
        static StackObject* get_StoryLog_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_Rewards_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
