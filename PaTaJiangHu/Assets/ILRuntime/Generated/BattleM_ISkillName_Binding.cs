...
{
    unsafe class BattleM_ISkillName_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BattleM.ISkillName);
            args = new Type[]{};
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BattleM.ISkillName instance_of_this_method = (BattleM.ISkillName)typeof(BattleM.ISkillName).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
