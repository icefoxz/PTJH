...
namespace ILRuntime.Runtime.Generated
{
    unsafe class _GameClient_Models_Faction_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_AdvProps", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_AdvProps_8);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, GetAllSupportedAdvItems_10);
        ...
        static StackObject* get_AdvProps_8(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.AdvProps;
        ...
        static StackObject* GetAllSupportedAdvItems_10(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
