...
{
    unsafe class System_Collections_Generic_IDictionary_2_String_ILAdapters_IListAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.IDictionary<System.String, ILAdapters.IListAdapter.Adapter>);
            args = new Type[]{};
            method = type.GetMethod("get_Keys", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Keys_0);
            args = new Type[]{typeof(System.String), typeof(ILAdapters.IListAdapter.Adapter)};
            ...
            args = new Type[]{typeof(System.String), typeof(ILAdapters.IListAdapter.Adapter).MakeByRefType()};
        ...
        static StackObject* get_Keys_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.IDictionary<System.String, ILAdapters.IListAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.IDictionary<System.String, ILAdapters.IListAdapter.Adapter>)typeof(System.Collections.Generic.IDictionary<System.String, ILAdapters.IListAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_Item_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILAdapters.IListAdapter.Adapter @value = (ILAdapters.IListAdapter.Adapter)typeof(ILAdapters.IListAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILAdapters.IListAdapter.Adapter @value = (ILAdapters.IListAdapter.Adapter)typeof(ILAdapters.IListAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILAdapters.IListAdapter.Adapter[];
