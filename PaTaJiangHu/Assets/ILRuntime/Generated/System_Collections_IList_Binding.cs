...
{
    unsafe class System_Collections_IList_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.IList);
            args = new Type[]{};
            method = type.GetMethod("get_IsFixedSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsFixedSize_0);
            args = new Type[]{};
            method = type.GetMethod("get_IsReadOnly", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsReadOnly_1);
            ...
            app.RegisterCLRMethodRedirection(method, RemoveAt_8);
            args = new Type[]{typeof(System.Object)};
        ...
        static StackObject* get_IsFixedSize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.IList instance_of_this_method = (System.Collections.IList)typeof(System.Collections.IList).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* get_IsReadOnly_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* Insert_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            instance_of_this_method.Insert(@index, @value);
        ...
        static StackObject* Remove_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Remove(@value);

            return __ret;
        }

        static StackObject* RemoveAt_8(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
