...
namespace AOT._AOT.Views.BaseUis
{
    public static class RectExtension
    {
        ...
        private static Vector3 SetX(this Vector3 vector, float x) => new Vector3(x, vector.y, vector.z);

        private static Vector2 SetX(this Vector2 vector, float x) => new Vector2(x, vector.y);
        ...
        public static void SetLocalScaleX(this Transform transform, float x) => transform.localScale = transform.localScale.SetX(x);

        // Set Y

        private static Vector3 SetY(this Vector3 vector, float y) => new Vector3(vector.x, y, vector.z);

        private static Vector2 SetY(this Vector2 vector, float y) => new Vector2(vector.x, y);
        ...
        public static void SetLocalScaleY(this Transform transform, float y) => transform.localScale = transform.localScale.SetY(y);

        // Set Z

        private static Vector3 SetZ(this Vector3 vector, float z) => new Vector3(vector.x, vector.y, z);
        ...
        public static void SetLocalScaleZ(this Transform transform, float z) => transform.localScale = transform.localScale.SetZ(z);

        // Set XY

        private static Vector3 SetXY(this Vector3 vector, float x, float y) => new Vector3(x, y, vector.z);
        ...
        public static void SetLocalScaleXY(this Transform transform, float x, float y) => transform.localScale = transform.localScale.SetXY(x, y);

        // Set XZ

        private static Vector3 SetXZ(this Vector3 vector, float x, float z) => new Vector3(x, vector.y, z);
        ...
        public static void SetLocalScaleXZ(this Transform transform, float x, float z) => transform.localScale = transform.localScale.SetXZ(x, z);

        // Set YZ

        private static Vector3 SetYZ(this Vector3 vector, float y, float z) => new Vector3(vector.x, y, z);
        ...
        public static void SetLocalScaleYZ(this Transform transform, float y, float z) => transform.localScale = transform.localScale.SetYZ(y, z);
